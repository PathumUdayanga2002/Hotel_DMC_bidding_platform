  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">DMC Profile Approvals</h1>
          <p className="text-gray-600 mt-2">Review and manage DMC registration requests</p>
        </div>
        <button
      ...
      <Card>
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 text-lg font-medium">No profiles found</p>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {profiles.map((profile) => (
                  <tr key={profile.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-600">{profile.businessRegistrationNumber}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
