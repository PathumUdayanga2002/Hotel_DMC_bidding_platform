      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-4">
            Start with a <span className="font-bold text-blue-600">completely free 30-day trial</span> with full access to all features. 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto mb-12">
          {plans.map((plan, index) => (
            ...
            >
              {plan.badge && (
                <div className="absolute top-0 right-0 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-1 rounded-bl-lg font-semibold text-sm">
                  {plan.badge}
                </div>
              )}
              ...
              <div className="p-8">
                ...
                {index !== 0 && (
                  <button
                    onClick={handleGetStarted}
                    className="w-full bg-gray-100 text-gray-800 py-4 rounded-lg font-semibold text-lg hover:bg-gray-200 transition-all duration-300"
                  >
                    Get Started →
                  </button>
                )}
        ...
        {/* CTA Section */}
        <div className="max-w-4xl mx-auto mt-16 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl shadow-2xl p-12 text-center text-white">
          <h2 className="text-4xl font-bold mb-4">
            Ready to Transform Your Business?
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Join hundreds of hotels and DMCs already using Respitch to grow their partnerships.
          </p>
          <button
            onClick={handleGetStarted}
            className="bg-white text-blue-600 px-12 py-4 rounded-lg font-bold text-xl hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
