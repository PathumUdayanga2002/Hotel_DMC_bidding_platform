...
const NotificationBell = () => {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      ...
      console.log('Notifications content:', response.content);
            ...
            <div className="flex items-center space-x-2">
              {unreadCount > 0 && (
                <button
                  ...
                  className="flex items-center space-x-1 px-3 py-1.5 bg-white/20 hover:bg-white/30 rounded-md text-xs font-medium transition-colors"
            ...
            <div className="px-4 py-3 bg-gray-50 border-t border-gray-200">
              <div className="flex items-center justify-between gap-2">
                {unreadCount > 0 && (
                  <button
                    onClick={handleMarkAllAsRead}
                    className="flex-1 px-4 py-2 bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-medium rounded-lg transition-colors flex items-center justify-center space-x-2"
                  >
                    <Check className="w-4 h-4" />
                ...
                <button
                  ...
                  className={`${unreadCount > 0 ? 'flex-1' : 'w-full'} px-4 py-2 bg-white hover:bg-gray-100 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg transition-colors`}
                >
                  View All
                </button>
              </div>
