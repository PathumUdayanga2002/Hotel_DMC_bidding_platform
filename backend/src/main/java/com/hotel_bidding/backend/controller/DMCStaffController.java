...
import com.hotel_bidding.backend.security.UserDetailsImpl;`nimport com.hotel_bidding.backend.service.StaffService;
...
public class DMCStaffController {
    ...
    public ResponseEntity<ApiResponse> createStaff(
        ...
        UserDetailsImpl userDetails = (UserDetailsImpl) authentication.getPrincipal();`n        String superAdminId = userDetails.getId();
    ...
    public ResponseEntity<ApiResponse> getAllStaff(Authentication authentication) {
        ...
        log.info("DMC fetching all staff");
        UserDetailsImpl userDetails = (UserDetailsImpl) authentication.getPrincipal();`n        String superAdminId = userDetails.getId();
    ...
    public ResponseEntity<ApiResponse> getStaffById(
        ...
        log.info("DMC fetching staff: {}", staffId);
        UserDetailsImpl userDetails = (UserDetailsImpl) authentication.getPrincipal();`n        String superAdminId = userDetails.getId();
